...
// DecodeAp decodes the Ap instance encoded in resp body.
func (c *Client) DecodeAp(resp *http.Response) (*Ap, error) {
	var decoded Ap
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}

// DecodeApVenue decodes the ApVenue instance encoded in resp body.
func (c *Client) DecodeApVenue(resp *http.Response) (*ApVenue, error) {
	var decoded ApVenue
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeVenue decodes the Venue instance encoded in resp body.
func (c *Client) DecodeVenue(resp *http.Response) (*Venue, error) {
	var decoded Venue
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}

// DecodeVenueDetailed decodes the VenueDetailed instance encoded in resp body.
func (c *Client) DecodeVenueDetailed(resp *http.Response) (*VenueDetailed, error) {
	var decoded VenueDetailed
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
